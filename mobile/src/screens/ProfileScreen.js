...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, SafeAreaView, ScrollView, Alert, Platform, StatusBar } from 'react-native';
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.headerBox}>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.headerSub}>Gestiona tu información personal</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.disabledInput}>
            <Text style={styles.disabledInputText}>18 de diciembre de 2025</Text>
          </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.statsGrid}>
            <View style={styles.statBox}>
              ...
              <Text style={[styles.statValue, { color: '#10B981' }]}>Activo</Text>
            </View>

            <View style={[styles.statBox, { borderColor: '#059669', backgroundColor: '#ECFDF5' }]}>
              <Text style={styles.statIcon}>🔒</Text>
              <Text style={[styles.statLabel, { color: '#047857' }]}>Seguridad</Text>
              <Text style={[styles.statValue, { color: '#059669' }]}>Protegido</Text>
            </View>

            <View style={styles.statBox}>
              <Text style={styles.statIcon}>💳</Text>
              <Text style={styles.statLabel}>Tipo</Text>
              <Text style={[styles.statValue, { color: '#8B5CF6' }]}>Usuario</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.actionBoxWarning}>
            <View style={{ flex: 1, paddingRight: 10 }}>
              ...
              <Text style={styles.actionSubWarning}>Salir de tu cuenta de forma segura</Text>
            </View>
            <TouchableOpacity style={styles.actionBtnWarning} onPress={handleLogoutConfirm} activeOpacity={0.8}>
          ...
          <View style={styles.actionBoxDanger}>
            <View style={{ flex: 1, paddingRight: 10 }}>
              ...
              <Text style={styles.actionSubDanger}>Eliminar permanentemente tu cuenta y todos los datos</Text>
            </View>
            <TouchableOpacity style={styles.actionBtnDanger} onPress={handleDeleteAccount} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  headerBox: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  ...
  cardSectionTitle: { fontSize: 16, fontWeight: 'bold', color: '#1F2937', marginBottom: 14 },
  label: { fontSize: 13, fontWeight: 'bold', color: '#374151', marginBottom: 6, marginTop: 8 },
  input: { backgroundColor: '#F9FAFB', color: '#1F2937', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 10, fontSize: 14, borderWidth: 1, borderColor: '#E5E7EB' },
  disabledInput: { backgroundColor: '#F3F4F6', paddingHorizontal: 14, paddingVertical: 12, borderRadius: 10, borderWidth: 1, borderColor: '#E5E7EB' },
  disabledInputText: { color: '#6B7280', fontSize: 14 },
  buttonRow: { flexDirection: 'row', gap: 10, marginTop: 18 },
  resetBtn: { flex: 1, backgroundColor: '#F3F4F6', paddingVertical: 12, borderRadius: 10, alignItems: 'center', borderWidth: 1, borderColor: '#D1D5DB' },
  resetBtnText: { color: '#374151', fontWeight: 'bold', fontSize: 13 },
  saveBtn: { flex: 1.2, backgroundColor: '#6EE7B7', paddingVertical: 12, borderRadius: 10, alignItems: 'center' },
  saveBtnText: { color: '#065F46', fontWeight: 'bold', fontSize: 13 },
  statsGrid: { flexDirection: 'row', gap: 8 },
  statBox: { flex: 1, backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 12, padding: 12, alignItems: 'center' },
  statIcon: { fontSize: 20, marginBottom: 4 },
  statLabel: { fontSize: 11, color: '#6B7280', fontWeight: '600' },
  statValue: { fontSize: 13, fontWeight: 'bold', marginTop: 2 },
  actionBoxWarning: { backgroundColor: '#FFFBEB', borderWidth: 1, borderColor: '#FDE68A', borderRadius: 12, padding: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 },
  actionTitleWarning: { fontSize: 14, fontWeight: 'bold', color: '#B45309' },
  actionSubWarning: { fontSize: 11, color: '#D97706', marginTop: 2 },
  actionBtnWarning: { backgroundColor: '#F59E0B', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8 },
  actionBtnTextWarning: { color: '#FFFFFF', fontSize: 12, fontWeight: 'bold' },
  actionBoxDanger: { backgroundColor: '#FEF2F2', borderWidth: 1, borderColor: '#FCA5A5', borderRadius: 12, padding: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  actionTitleDanger: { fontSize: 14, fontWeight: 'bold', color: '#B91C1C' },
  actionSubDanger: { fontSize: 11, color: '#DC2626', marginTop: 2 },
  actionBtnDanger: { backgroundColor: '#EF4444', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8 },
